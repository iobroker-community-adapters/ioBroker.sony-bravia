...
class Bravia {
    ...
    getContentList(_startIndex, _count, _source) {
        return new Promise((resolve, reject) => {
            this.getSupportedApiVersion("avContent", "getContentList").then(version => {
                getContentList(_startIndex, _count, _source, version).then(result => {
                    resolve(result);
                }).catch(error => {
                    reject(error);
                });
                ...
                getContentList(_startIndex, _count, _source, "1.0").then(result => {
                    resolve(result);
                }).catch(error => {
                    resolve([]);
                });
    ...
    getContentList(_startIndex, _count, _source, _version) {
